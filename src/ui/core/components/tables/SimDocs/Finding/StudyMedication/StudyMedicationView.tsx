...
import TextField from '@components/mui/inputs/TextField/TextField'
...
function StudyMedicationView({}: Props) {
  const {
    findingStore,
    simDocStore,
    uiState: { modal },
  ...
  return (
    <Box>
      ...
      <Box>
        ...
        <TextField
          label={'Number of pills prescribed'}
          type="number"
          value={findingStore.selectedSimDoc?.numberOfPillsPrescribed}
          state={findingStore}
          path={'selectedSimDoc.numberOfPillsPrescribed'}
          sx={{ maxWidth: '400px' }}
        />
      </Box>
    </Box>
...
export default compose<any>()(observer(StudyMedicationView))
