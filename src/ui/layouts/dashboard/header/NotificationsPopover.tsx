    ...
    <>
      ...
      >
        <Badge badgeContent={totalUnRead} color="error">
          <Iconify icon="eva:bell-fill" width={20} height={20} color="white" />
        </Badge>
      </IconButtonAnimate>
        ...
        <Scrollbar sx={{ height: { xs: 340, sm: 'auto' } }}>
          ...
          >
            {notifications.slice(0, 2).map((notification) => (
              <NotificationItem key={'sdasd'} notification={notification} />
            ))}
          </List>
          ...
          >
            {notifications.slice(2, 5).map((notification) => (
              <NotificationItem key={'ss'} notification={notification} />
            ))}
          </List>
        </Scrollbar>
